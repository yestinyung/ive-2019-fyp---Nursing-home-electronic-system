...
public class UpdatePatientDetailByDoctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_patient_detail_by_doctor);
        ...
        if (!haveData) { // Access to get information
            Toast toast = Toast.makeText(UpdatePatientDetailByDoctor.this, "Error", Toast.LENGTH_LONG);
            toast.show();
        } else {
            ...
            ArrayAdapter<String> ArrayAdapter = new ArrayAdapter<>(UpdatePatientDetailByDoctor.this, android.R.layout.simple_spinner_dropdown_item, departmentName);
    ...
    private class UpdatePatientDetailByDoctorInBackground extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(UpdatePatientDetailByDoctor.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {
                ...
                Toast toast = Toast.makeText(UpdatePatientDetailByDoctor.this, "Record updated successfully", Toast.LENGTH_LONG);
                toast.show();
                finish();
            } else {
                Toast toast = Toast.makeText(UpdatePatientDetailByDoctor.this, "Exception", Toast.LENGTH_LONG);
                toast.show();
                return;
            }
        }
    ...
    private void showOneDialog() {
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new UpdatePatientDetailByDoctorInBackground().execute();
                build.dismiss();
            }
        });
